...
interface AllCredentialsApiResponse {
  ...
  userCredentials: Array<IosDistCredentials | IosPushCredentials>;
}

// This class should not be used dirrectly, use only as part of cached api client from ./IosApi.ts
// or mock it in tests (it's easier to mock this class than ApiV2 dirrectly)
